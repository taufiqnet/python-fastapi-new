        ...
        "items": [
            {
                ...
                "description": "Organize workforce hierarchy and department structures effortlessly — upgrade to unlock.",
            ...
            },
            {
                ...
                "plans": ["Free", "Basic", "Pro", "Enterprise", "hr payroll module (free tier)"],
                "description": "Define career paths and standardize job titles across teams — upgrade to unlock.",
            ...
            },
            {
                ...
                "plans": ["Free", "Basic", "Pro", "Enterprise", "hr payroll module (free tier)"],
                "description": "Manage comprehensive employee records and directory — upgrade to unlock.",
        ...
        "items": [
            {
                ...
                "description": "Track real-time employee attendance and work hours — upgrade to unlock.",
            ...
            },
            {
                ...
                "plans": ["Basic", "Pro", "Enterprise", "hr payroll module (free tier)"],
                "description": "Customize paid and unpaid leave policies — upgrade to unlock.",
            ...
            },
            {
                ...
                "plans": ["Basic", "Pro", "Enterprise", "hr payroll module (free tier)"],
                "description": "Automate annual leave balance distribution — upgrade to unlock.",
            ...
            },
            {
                ...
                "plans": ["Basic", "Pro", "Enterprise", "hr payroll module (free tier)"],
                "description": "Streamline leave application and approval workflows — upgrade to unlock.",
            ...
            },
            {
                ...
                "plans": ["Basic", "Pro", "Enterprise", "hr payroll module (free tier)"],
                "description": "Manage company holiday calendars and official off days — upgrade to unlock.",
        ...
        "items": [
            {
                ...
                "plans": ["Basic", "Pro", "Enterprise", "hr payroll module (free tier)"],
                "description": "Schedule and run recurring pay periods seamlessly — upgrade to unlock.",
            ...
            },
            {
                ...
                "plans": ["Basic", "Pro", "Enterprise", "hr payroll module (free tier)"],
                "description": "Automate salary runs and payslips in one click — upgrade to unlock.",
            ...
            },
            {
                ...
                "description": "Structure pay grades, bonuses, and compensation packages — upgrade to Pro to unlock.",
            ...
            },
            {
                ...
                "plans": ["Pro", "Enterprise"],
                "description": "Configure advanced salary components, tax rules, and deductions — upgrade to Pro to unlock.",
        ...
        "items": [
            {
                ...
                "plans": ["Pro", "Enterprise"],
                "description": "Upskill your team with automated training programs and skill tracking — upgrade to Pro to unlock.",
            ...
            },
            {
                ...
                "plans": ["Enterprise"],
                "description": "Drive team excellence with 360-degree performance reviews and KPI tracking — upgrade to Enterprise to unlock.",
        ...
        "items": [
            {
                ...
                "plans": ["Pro", "Enterprise"],
                "description": "Source, track, and hire top talent with an integrated applicant tracking system — upgrade to Pro to unlock.",
            ...
            },
            {
                ...
                "permission_code": "hrm:recruitment:view",
                "plans": ["Pro", "Enterprise"],
                "description": "Schedule candidate interviews and gather structured interviewer feedback — upgrade to Pro to unlock.",
        ...
        "items": [
            {
                ...
                "plans": ["Basic", "Pro", "Enterprise", "hr payroll module (free tier)"],
                "description": "Generate official employee appointment letters instantly — upgrade to unlock.",
            ...
            },
            {
                ...
                "plans": ["Basic", "Pro", "Enterprise", "hr payroll module (free tier)"],
                "description": "Issue verified salary certificates for bank and official purposes — upgrade to unlock.",
            ...
            },
            {
                ...
                "plans": ["Basic", "Pro", "Enterprise", "hr payroll module (free tier)"],
                "description": "Send customizable job offer letters to new hires — upgrade to unlock.",
            ...
            },
            {
                ...
                "plans": ["Basic", "Pro", "Enterprise", "hr payroll module (free tier)"],
                "description": "Generate work experience letters for departing team members — upgrade to unlock.",
        ...
        "items": [
            {
                ...
                "plans": ["Basic", "Pro", "Enterprise", "hr payroll module (free tier)"],
                "description": "Broadcast company-wide announcements and policy updates — upgrade to unlock.",
        ...
        "items": [
            {
                ...
                "description": "Organize product catalogs with dynamic category hierarchies — upgrade to unlock.",
            ...
            },
            {
                ...
                "plans": ["Basic", "Pro", "Enterprise", "ecommerce module (free tire)"],
                "description": "Track customer profiles, purchase histories, and insights — upgrade to unlock.",
            ...
            },
            {
                ...
                "plans": ["Basic", "Pro", "Enterprise", "ecommerce module (free tire)"],
                "description": "Manage product brands and manufacturer relationships — upgrade to unlock.",
                "active_page": "brands",
            },
            {
                "key": "models",
                ...
                "plans": ["Basic", "Pro", "Enterprise", "ecommerce module (free tire)"],
                "description": "Categorize product models and technical specifications — upgrade to unlock.",
                "active_page": "models",
            },
            {
                "key": "products",
                ...
                "plans": ["Basic", "Pro", "Enterprise", "ecommerce module (free tire)"],
                "description": "Publish products, SKUs, and pricing matrices — upgrade to unlock.",
            ...
            },
            {
                ...
                "plans": ["Basic", "Pro", "Enterprise", "ecommerce module (free tire)"],
                "description": "Process multi-channel store orders and fulfillment — upgrade to unlock.",
                "active_page": "orders",
            },
            {
                "key": "inventory",
                ...
                "plans": ["Basic", "Pro", "Enterprise", "ecommerce module (free tire)"],
                "description": "Monitor stock levels, multi-warehouse inventory, and alerts — upgrade to unlock.",
